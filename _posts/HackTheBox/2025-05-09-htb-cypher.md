...
![alt text](../../assets/img/cypher/image.png)
...
![alt text](../../assets/img/cypher/image2.png)
...
![alt text](../../assets/img/cypher/image3.png)
...
Using a `'` inside the Username in the login panel at [http://cypher.htb/login](http://cypher.htb/login) seems to break the cypher query it's using:
 ![alt text](../../assets/img/cypher/image4.png)
...
![alt text](../../assets/img/cypher/image5.png)
